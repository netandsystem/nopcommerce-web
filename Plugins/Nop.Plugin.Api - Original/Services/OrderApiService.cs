...
namespace Nop.Plugin.Api.Services
{
    public class OrderApiService : IOrderApiService
    {
        ...
        public IList<Order> GetOrders(
            ...
            int? storeId = null, bool orderByDateDesc = false)
        {
            var query = GetOrdersQuery(createdAtMin, createdAtMax, status, paymentStatus, shippingStatus, ids, customerId, storeId, orderByDateDesc);
        ...
        private IQueryable<Order> GetOrdersQuery(
            ...
            int? customerId = null, int? storeId = null, bool orderByDateDesc = false)
        {
