...
public class DependencyRegister : INopStartup
{
    ...
    public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IInvoiceApiService, InvoiceApiService>();
        services.AddScoped<IReportApiService, ReportApiService>();
        services.AddScoped<IWorkflowMessageService, WorkflowMessageService>();
        services.AddScoped<IPdfService, PdfService>();
        services.AddScoped<ISettingApiService, SettingApiService>();
        services.AddScoped<IQueuedEmailApiService, QueuedEmailApiService>();
