...
#nullable enable
        void AddReportTokensAsync(Report report, IList<Token> tokens, MessageTemplate messageTemplate);

        void AddReportTokensInDefaultTemplateAsync(Report report, MessageTemplate defultMessageTemplate, MessageTemplate messageTemplate, IList<Token> tokens);
    }
}