...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <returns></returns>
        Task<int> SendReportEmailTestAsync(string body, string attachmentFilePath, string attachmentFileName);
...
#nullable enable
        ...
        /// The task result contains the queued email identifier
        /// </returns>
        Task<int> SendNotification2Async(MessageTemplate messageTemplate,
            EmailAccount emailAccount, int languageId, IList<Token> tokens,
            string toEmailAddress, string toName,
            string? attachmentFilePath = null, string? attachmentFileName = null,
            string? replyToEmailAddress = null, string? replyToName = null,
        ...
        Task<QueuedEmail> GetQueuedEmailFromReportAsync(Report report, bool useTemplate = true);

        //=========================

        Task<(List<int>, List<SendReportEmailAsyncErrors>)> SendReportEmailAsync(List<SendReportEmailAsyncParams> data);
