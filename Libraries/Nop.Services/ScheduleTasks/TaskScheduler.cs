    ...
    public partial class TaskScheduler : ITaskScheduler
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            foreach (var scheduleTask in scheduleTasks)
            {
                ...
                if (scheduleTask.InitialDateUtc.HasValue && scheduleTask.InitialDateUtc >= DateTime.UtcNow)
                {

                    taskThread.InitSeconds = (int)(scheduleTask.InitialDateUtc - DateTime.UtcNow).Value.TotalSeconds + 1;
                ...
                else if (scheduleTask.LastStartUtc.HasValue)
                {
