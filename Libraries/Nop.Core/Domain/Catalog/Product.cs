...
namespace Nop.Core.Domain.Catalog
{
    ...
    /// </summary>
    public partial class Product : BaseSyncEntity2, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountProductMapping>, ISoftDeletedEntity
    {
        /// <summary>
